...
const HelperButtonts = ({
  ...
  return (
    <div className='flex gap-4'>
      ...
      <div className='w-16 h-16 text-white bg-[var(--primary-blue)] flex justify-center items-center text-3xl cursor-pointer rounded-lg shadow-sm hover:scale-110 transition-transform'>
        <FaQuestion />
      </div>
    </div>
  );
